    ...
    stages {
        ...
        stage('SonarScanner Analyze') {
            steps {
                ...
                sh './gradlew sonarqube -Dsonar.projectkey=java-app -Dsonar.host.url=http://192.168.56.11:9000 -Dsonar.login=c78ef6b0d5c4a0a233dad41f1db87883a91bca71 -Dsonar.verbose=true'
            }
        }
        stage('Publish') {
            steps {
